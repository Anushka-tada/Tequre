  ...
  return (
    <>
          ...
          <div className=" row  ">
            <div className="mt-5 col-md-5 col-12 ">
              <h2 className="mb-3 fw-bold">
                Oracle Application Cloud <br></br>a Service for Oracle
              </h2>
              <p className="mb-4 text-gray medium-text">
                Build applications based on Serverless architecture so that your
                developers can focus on code without worrying about the servers
                and cost.{" "}
              </p>
              <button
          ...
          <div className="row">
            ...
            <div className="col-md-5 col-12 p-5">
              ...
              <p className="text-gray py-2">
                Fission allows you to code serverless functions in any language
                and have them run wherever you have a Kubernetes cluster - in
                the public cloud, on-premises, on your laptop, or at the Edge!
              </p>
              <p className="text-gray py-2">
                Fission automatically manages the infrastructure for you. You
                can focus on your code, while you get the most out of Kubernetes
                infrastructure, without requiring any in-depth knowledge of
                Kubernetes at scale, no containers to build or registries to
                manage.
              </p>
            </div>
          </div>
        ...
        <div className=" container mt-5">
          ...
          <div className=" px-5 mt-5">
            <div className="col col-12  px-5 py-2 ">
              <div className="row  ">
                {/* Row 1 */}
                <div className="col-md-6 col-12  p-3 bg-white management ">
                  <img
                  ...
                  <p className="text-gray">
                    Developers can focus on writing the business logic, while
                    Fission takes care of building, deploying and managing the
                    infrastructure.
                  </p>
                </div>
                ...
                <div className="col-md-6 col-12 p-3 bg-white management">
                  ...
                  <p className="text-gray">
                    Why get locked with your cloud provider while you can run
                    the same serverless experience with Fission.
                  </p>
                </div>
              </div>
              ...
              <div className="row  mt-3">
                ...
                <div className="col-md-6 col-12 p-3 bg-white management">
                  ...
                  <p className="text-gray">
                    Best alternative to cloud provider's serverless offering,
                    which is more economical and flexible to your needs.
                  </p>
                </div>
      ...
      <div className="">
        <div className=" container mt-5">
          <div className="text-center">
            ...
            <p className="text-gray">
              Select the number of function invocations and see how much you can
              save with <br></br>Fission over other leading providers.
            </p>
          </div>
          <div className="row border border-red">
            <div className="col-md-8 col-12 box-shadow">
              ...
              <div className="border border-red p-2 mb-2">select</div>
            </div>

            <div className="col-md-4 col-12 border border-red">data box</div>
          </div>

          <div className="text-center py-4 px-2">
            <a href="/contactus" className="contactus-a">
              <button
                className="contact-btn text-white shadow my-auto "
                style={{ background: "#C0202E", border: "none" }}
              >
                Contact Us
              </button>
                ...
                <div className=" container mt-5 text-white">
                    ...
                    <div className="d-flex justify-content-around flex-wrap mt-5">
                        <div className="text-center">
                            ...
                            <p>Contributors</p>
                           <div className='rounded rounded-lg p-3 bg-white'>
                           <img
                        ...
                        <div className="text-center">
                            ...
                            <p>Stars</p>
                           <div className='rounded rounded-lg p-3 px-4 bg-white'>
                           <img
                        ...
                        <div className="text-center">
                            ...
                            <p>Forks</p>
                            <div className='rounded rounded-lg py-2 px-4 bg-white'>
                            <img
        ...
        <div className=" container mt-5">
          ...
          <div className="row d-flex justify-content-around mt-5">
            <div className="col-md-3 col-12 p-2 hover-effect hover-shadow">
              ...
              <p className="text-gray">
                <span className="orange-color">Join the Fission community</span>{" "}
                to engage with the fission team, interact with other users, and
            ...
            <div className="col-md-3 col-12 p-2 hover-effect hover-shadow">
              ...
              <p className="text-gray">
                Dive into the code, learn more about Fission.{" "}
                <span className="orange-color">Submit PRs and collaborate</span>{" "}
                with others like-minded contributors.
              </p>
            </div>
            ...
            <div className="col-md-3 col-12 p-2 hover-effect hover-shadow">
              ...
              <p className="text-gray">
                Follow us <span className="orange-color">@Fission</span> to stay
                up date with Fission news, updates and annoucements.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-5 mb-5">
        <div
          className="mt-5 mb-5 p-5 border border-gray container bg-purple text-center"
          style={{ borderRadius: "12px" }}
        >
          <h3 className="p-2 text-white">
            Let your Developers Focus on the Code without <br></br>Worrying
            about the Kubernetes Clusters.
          </h3>
          <a  href="/contactus" className="contactus-a">
          <button
