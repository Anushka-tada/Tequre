...
function ContactSection() {
  return (
    <div className="container mt-5 pt-4 px-0 mx-0">
      <div className="pageHeading ">
        <h2 >Contact Us</h2>
        
      </div>
      <div className="row m-0 p-0  contactLeftDiv1">
        <div className="col-lg-6 col-12 mt-5 p-0   ">
           <img src="/assets/contact-img.png" className="contact-img"></img>
        </div>
        <div className="col-lg-6 col-12 mt-5 p-0 order-1 order-lg-2 touch-form" >
      ...
      <div className="col-lg-4 col-12 order-2 order-lg-1 m-0 my-auto  p-0">
