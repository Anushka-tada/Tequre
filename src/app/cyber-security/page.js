                ...
                <div className="container">
                    <div className=" row  ">
                        ...
                        <div className="mt-5 col-md-5 col-12 ">
                            <h2 className="mb-3 fw-bold">Cyber Security <br></br>Made Simple</h2>
                ...
                <div className=" container mt-5 text-white">
                    ...
                    <div className="d-flex justify-content-around flex-wrap mt-5">
                        <div className="text-center">
                            ...
                            <p>Contributors</p>
                          <div className='bg-white p-3 rounded rounded-lg'>
                          <img
                        ...
                        <div className="text-center">
                            ...
                            <p>Stars</p>
                            <div  className='bg-white p-3 px-4  rounded rounded-lg'>
                            <img
                        ...
                        <div className="text-center">
                            ...
                            <p>Forks</p>
                          <div className='bg-white px-4 py-2 rounded rounded-lg'>
                          <img
