    ...
    return (
        ...
        <div className='my-5 py-1'></div>
                ...
                <div className="container">
                    <div className=" row  ">
                        ...
                        <div className="mt-5 col-md-6 col-12 ">
                            <h2 className="mb-3 fw-bold">Low Code Platform</h2>
                ...
                <div className=" container mt-5 py-5">
                    ...
                    <div className=" px-5 mt-5">
                        <div className="col col-12  px-5 py-2 ">
                            <div className="row  ">
                                {/* Row 1 */}
                                <div className="col-md-6  col-12 management  p-3 bg-white">
                            ...
                            <div className="row  mt-3">
                                {/* Row 2 */}
                                <div className="col-md-6 col-12 p-3 management bg-white">
            ...
            <div className=" bg-light-green row py-5">
                ...
                <div className=" bg-red  col-lg-3 col-0"></div>
            </div>
            ...
            <div className="bg-white">
                <div className="border border-gray container mt-5 mb-5 ">
            ...
            <div className="bg-dark-blue">
                ...
                <div className="container mt-5 p-3 text-white">
                    ...
                    <div className=" p-3 mb-3 text-center">
                        <h2 className="fw-bold text-dark">Ready to Get Started with Managed Services for K8s?</h2>
                        <p className="fs-6 text-dark">Discuss your project with one of the Managed Services experts.</p>
                    </div>
